            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case 6:
                        ...
                        String str3 = DateUtil.parseDateToString(calendar.getTime(), DateUtil.DatePattern.YYYYMMDDHHMMSS);
                        PreferencesUtils.putString(getApplicationContext(), "lastSendTime", str3);
                        break;
                }
            }
        };
